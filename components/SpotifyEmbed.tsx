    ...
    <section className="py-20 px-6 bg-cream-dark relative">
      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="body-text mb-8">
          We&apos;d love for you to add your favorite songs to our wedding playlist! 
          Add songs that will get you on the dance floor.
        </p>
        ...
        <p className="text-sm text-charcoal-light mt-6">
          To add songs: Open the playlist in Spotify, click the three dots, 
          and select &ldquo;Add to playlist&rdquo; on any song you want to include!
        </p>
      </div>
    </section>
  )
